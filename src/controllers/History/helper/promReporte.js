                        ...
                        if (subelement.materia?.computo==2) {
                            ...
                            for (let m = 0; m < computo.length; m++) {
                                ...
                                if (subelement.fkmaterias == result.fkmateria) {
                                    if(result.resultados?.supletorio !=''||result.resultados?.remedial !=''||result.resultados?.gracia !=''){
                                        if(result.resultados?.supletorio !='') promedio = result.resultados.supletorio;
                                        if(result.resultados?.remedial !='') promedio = result.resultados.remedial;
                                        if(result.resultados?.gracia !='') promedio = result.resultados.gracia;
                                    } 
                            ...
                            for (let m = 0; m < computo.length; m++) {
                                ...
                                if (subelement.fkmaterias == result.fkmateria) {
                                  ...
                                  if(result.materia?.nombre=='COMPORTAMIENTO')  promedio = 'A' 
                                  else {
                                    const nott = ['EX', 'MB','MB']
                                    const ramdom = Math.floor(Math.random()*nott.length)
                                    promedio = nott[ramdom]
                                }
                                }
                            }
                        ...
                        if (subelement.materia?.computo==2) {
                            ...
                            for (let m = 0; m < computo.length; m++) {
                                ...
                                if (subelement.fkmaterias == result.fkmateria) {
                                    ...
                                    final = res?.notaFinal
                                    promedioFinal = res?.promedioFinal
                                    if(res?.supletorio !=''||res?.remedial !=''||res?.gracia !=''){
                                        if(res?.supletorio !='') final = res.supletorio;
                                        if(res?.remedial !='') final = res.remedial;
                                        if(res?.gracia !='') final = res.gracia;
                                    } else final = res?.notaFinal
                                }
                            }
