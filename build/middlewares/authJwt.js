...
var verifiUser = function verifiUser(param) {
  if (param.includes('Admin') || param.includes('Docente') || param.includes('Secretario') || param.includes('Estudiante') || param.includes('Inspector') || param.includes('Vicerrector')) return true;
  return false;
};
