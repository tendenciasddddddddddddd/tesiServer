...
var MAX_UID = 1e6,
    ...
    toType = e => null == e ? "".concat(e) : Object.prototype.toString.call(e).match(/\s([a-z]+)/i)[1].toLowerCase(),
    getUID = e => {
  do {
  ...
  "loading" === document.readyState ? (DOMContentLoadedCallbacks.length || document.addEventListener("DOMContentLoaded", () => {
    for (var _e of DOMContentLoadedCallbacks) {
      _e();
    }
  ...
  t = () => {
    ...
    for (var _e2 of DOMContentLoadedCallbacks) {
      _e2();
    }
...
function addHandler(e, t, n, i, s) {
  ...
  var [o, r, a] = normalizeParameters(t, n, i);

  if (t in customEvents) {
    var _e3 = e => function (t) {
  ...
  var d = makeEventUid(r, t.replace(namespaceRegex, "")),
...
function removeNamespacedHandlers(e, t, n, i) {
  ...
  for (var o of Object.keys(s)) {
    if (o.includes(i)) {
      var _i = s[o];
      removeHandler(e, t, n, _i.callable, _i.delegationSelector);
    }
  }
}
...
var EventHandler = {
  ...
  off(e, t, n, i) {
    ...
    var [s, o, r] = normalizeParameters(t, n, i),
        a = r !== t,
    ...
    if (void 0 === o) {
      if (_) for (var _n of Object.keys(l)) {
        removeNamespacedHandlers(e, l, _n, t.slice(1));
      }

      for (var _n2 of Object.keys(c)) {
        var _i2 = _n2.replace(stripUidRegex, "");

        if (!a || t.includes(_i2)) {
          var _t2 = c[_n2];
          removeHandler(e, l, r, _t2.callable, _t2.delegationSelector);
        }
      }
    } else {
...
var Manipulator = {
  ...
  getDataAttributes(e) {
    ...
    for (var i of n) {
      ...
      _n3 = _n3.charAt(0).toLowerCase() + _n3.slice(1, _n3.length), t[_n3] = normalizeData(e.dataset[i]);
    }

    return t;
  },

  getDataAttribute: (e, t) => normalizeData(e.getAttribute("data-bs-".concat(normalizeDataKey(t))))
};
...
class Config {
  ...
  _mergeConfigObj(e, t) {
    ...
    return _objectSpread(_objectSpread(_objectSpread(_objectSpread({}, this.constructor.Default), "object" == typeof n ? n : {}), isElement(t) ? Manipulator.getDataAttributes(t) : {}), "object" == typeof e ? e : {});
  }
  ...
  _typeCheckConfig(e) {
    ...
    for (var i of Object.keys(t)) {
      var s = t[i],
          o = e[i],
          r = isElement(o) ? "element" : null == (n = o) ? "".concat(n) : Object.prototype.toString.call(n).match(/\s([a-z]+)/i)[1].toLowerCase();
      if (!new RegExp(s).test(r)) throw new TypeError("".concat(this.constructor.NAME.toUpperCase(), ": Option \"").concat(i, "\" provided type \"").concat(r, "\" but expected type \"").concat(s, "\"."));
    }
...
class BaseComponent extends Config {
  ...
  dispose() {
    ...
    for (var e of Object.getOwnPropertyNames(this)) {
      this[e] = null;
    }
  }
...
var SelectorEngine = {
  ...
  focusableChildren(e) {
    var t = ["a", "button", "input", "textarea", "select", "details", "[tabindex]", '[contenteditable="true"]'].map(e => "".concat(e, ":not([tabindex^=\"-\"])")).join(",");
...
class Carousel extends BaseComponent {
  ...
  _addTouchEventListeners() {
    for (var _e4 of SelectorEngine.find(SELECTOR_ITEM_IMG, this._element)) {
      EventHandler.on(_e4, EVENT_DRAG_START, e => e.preventDefault());
    }
...
class Collapse extends BaseComponent {
  constructor(e, t) {
    ...
    for (var _e5 of n) {
      var _t3 = getSelectorFromElement(_e5),
          _n4 = SelectorEngine.find(_t3).filter(e => e === this._element);

      null !== _t3 && _n4.length && this._triggerArray.push(_e5);
    }
  ...
  hide() {
    ...
    for (var _e6 of this._triggerArray) {
      var t = getElementFromSelector(_e6);
      t && !this._isShown(t) && this._addAriaAndCollapsedClass([_e6], !1);
    }
  ...
  _initializeChildren() {
    ...
    for (var t of e) {
      var _e7 = getElementFromSelector(t);

      _e7 && this._addAriaAndCollapsedClass([t], this._isShown(_e7));
    }
  }
...
EventHandler.on(document, EVENT_CLICK_DATA_API$4, SELECTOR_DATA_TOGGLE$4, function (e) {
  ...
  for (var _e8 of n) {
    Collapse.getOrCreateInstance(_e8, {
      toggle: !1
    }).toggle();
  }
...
class Dropdown extends BaseComponent {
  ...
  show() {
    ...
    if (!EventHandler.trigger(this._element, EVENT_SHOW$5, e).defaultPrevented) {
      if (this._createPopper(), "ontouchstart" in document.documentElement && !this._parent.closest(".navbar-nav")) for (var _e9 of [].concat(...document.body.children)) {
        EventHandler.on(_e9, "mouseover", noop);
      }
  ...
  _completeHide(e) {
    if (!EventHandler.trigger(this._element, EVENT_HIDE$5, e).defaultPrevented) {
      if ("ontouchstart" in document.documentElement) for (var _e10 of [].concat(...document.body.children)) {
        EventHandler.off(_e10, "mouseover", noop);
      }
  ...
  _getConfig(e) {
    if ("object" == typeof (e = super._getConfig(e)).reference && !isElement(e.reference) && "function" != typeof e.reference.getBoundingClientRect) throw new TypeError("".concat(NAME$a.toUpperCase(), ": Option \"reference\" provided type \"object\" without a required \"getBoundingClientRect\" method."));
    return e;
  }
  ...
  _selectMenuItem(_ref2) {
    ...
    var n = SelectorEngine.find(SELECTOR_VISIBLE_ITEMS, this._menu).filter(e => isVisible(e));
...
class ScrollBarHelper {
  ...
  _applyManipulationCallback(e, t) {
    if (isElement(e)) t(e);else for (var n of SelectorEngine.find(e, this._element)) {
      t(n);
    }
  }
...
class Modal extends BaseComponent {
  ...
  dispose() {
    for (var e of [window, this._dialog]) {
  ...
  _adjustDialog() {
    ...
    if (n && !e) {
      var _e11 = isRTL() ? "paddingLeft" : "paddingRight";

      this._element.style[_e11] = "".concat(t, "px");
    }

    if (!n && e) {
      var _e12 = isRTL() ? "paddingRight" : "paddingLeft";

      this._element.style[_e12] = "".concat(t, "px");
    }
  }
...
EventHandler.on(document, EVENT_CLICK_DATA_API$1, SELECTOR_DATA_TOGGLE$1, function (e) {
  ...
  for (var e of SelectorEngine.find(OPEN_SELECTOR)) {
    Offcanvas.getOrCreateInstance(e).show();
  }
}), EventHandler.on(window, EVENT_RESIZE, () => {
  for (var e of SelectorEngine.find("[aria-modal][class*=show][class*=offcanvas-]")) {
...
function sanitizeHtml(e, t, n) {
  ...
  for (var _e13 of s) {
    var _n5 = _e13.nodeName.toLowerCase();
    ...
    var _i3 = [].concat(..._e13.attributes),
        _s = [].concat(t["*"] || [], t[_n5] || []);

    for (var _t6 of _i3) {
      allowedAttribute(_t6, _s) || _e13.removeAttribute(_t6.nodeName);
    }
  }
...
class TemplateFactory extends Config {
  ...
  toHtml() {
    ...
    for (var [_t7, _n6] of Object.entries(this._config.content)) {
...
class Tooltip extends BaseComponent {
  ...
  show() {
    ...
    if (this._element.ownerDocument.documentElement.contains(this.tip) || (i.append(n), EventHandler.trigger(this._element, this.constructor.eventName("inserted"))), this._popper = this._createPopper(n), n.classList.add("show"), "ontouchstart" in document.documentElement) for (var _e14 of [].concat(...document.body.children)) {
      EventHandler.on(_e14, "mouseover", noop);
    }
  ...
  hide() {
    if (this._isShown() && !EventHandler.trigger(this._element, this.constructor.eventName("hide")).defaultPrevented) {
      if (this._getTipElement().classList.remove("show"), "ontouchstart" in document.documentElement) for (var e of [].concat(...document.body.children)) {
  ...
  _setListeners() {
    ...
    for (var t of e) {
      if ("click" === t) EventHandler.on(this._element, this.constructor.eventName("click"), this._config.selector, e => {
        ...
        var _e15 = "hover" === t ? this.constructor.eventName("mouseenter") : this.constructor.eventName("focusin"),
            n = "hover" === t ? this.constructor.eventName("mouseleave") : this.constructor.eventName("focusout");

        EventHandler.on(this._element, _e15, this._config.selector, e => {
  ...
  _getConfig(e) {
    ...
    for (var _e16 of Object.keys(t)) {
      DISALLOWED_ATTRIBUTES.has(_e16) && delete t[_e16];
    }

    return e = _objectSpread(_objectSpread({}, t), "object" == typeof e && e ? e : {}), e = this._mergeConfigObj(e), e = this._configAfterMerge(e), this._typeCheckConfig(e), e;
  }
...
class ScrollSpy extends BaseComponent {
  ...
  _configAfterMerge(e) {
    return e.target = getElement(e.target) || document.body, e.rootMargin = e.offset ? "".concat(e.offset, "px 0px -30%") : e.rootMargin, "string" == typeof e.threshold && (e.threshold = e.threshold.split(",").map(e => Number.parseFloat(e))), e;
  }
  ...
  _maybeEnableSmoothScroll() {
    this._config.smoothScroll && (EventHandler.off(this._config.target, EVENT_CLICK), EventHandler.on(this._config.target, EVENT_CLICK, "[href]", e => {
      ...
      if (t) {
        e.preventDefault();
        var n = this._rootElement || window,
  ...
  _observerCallback(e) {
    var t = e => this._targetLinks.get("#".concat(e.target.id)),
        n = e => {
    ...
    for (var o of e) {
      ...
      var _e17 = o.target.offsetTop >= this._previousScrollData.visibleEntryTop;
  ...
  _initializeTargetsAndObservables() {
    ...
    for (var t of e) {
      ...
      var _e18 = SelectorEngine.findOne(t.hash, this._element);

      isVisible(_e18) && (this._targetLinks.set(t.hash, t), this._observableSections.set(t.hash, _e18));
    }
  }
  ...
  _activateParents(e) {
    if (e.classList.contains("dropdown-item")) SelectorEngine.findOne(".dropdown-toggle", e.closest(".dropdown")).classList.add("active");else for (var t of SelectorEngine.parents(e, ".nav, .list-group")) {
      for (var _e19 of SelectorEngine.prev(t, SELECTOR_LINK_ITEMS)) {
        _e19.classList.add("active");
      }
    }
  }
...
EventHandler.on(window, EVENT_LOAD_DATA_API$1, () => {
  for (var e of SelectorEngine.find(SELECTOR_DATA_SPY)) {
...
class Tab extends BaseComponent {
  ...
  _setInitialAttributes(e, t) {
    ...
    for (var _e21 of t) {
      this._setInitialAttributesOnChild(_e21);
    }
  }
...
EventHandler.on(document, "click.bs.tab", SELECTOR_DATA_TOGGLE, function (e) {
  ...
  for (var e of SelectorEngine.find(SELECTOR_DATA_TOGGLE_ACTIVE)) {
