...
var _Destrezas = _interopRequireDefault(require("../../models/registros/Destrezas.js"));
...
var _default = {
  create: function () {
    var _create = _asyncToGenerator(function* (req, res) {
      ...
      try {
        var newData = new _Destrezas.default({
          curso,
          fkcurso,
          ambitos
        });
  ...
  get: function () {
    var _get = _asyncToGenerator(function* (req, res) {
      try {
        ...
        var total = yield _Destrezas.default.countDocuments();
        var paginas = Math.ceil(total / limit);
        var collections = yield _Destrezas.default.find().skip(limit * skip - limit).limit(limit).lean();
        var coleccion = {
  ...
  getListas: function () {
    var _getListas = _asyncToGenerator(function* (req, res) {
      try {
        var result = yield _Destrezas.default.find().lean();
  ...
  getById: function () {
    var _getById = _asyncToGenerator(function* (req, res) {
      try {
        ...
        var result = yield _Destrezas.default.findOne({
          fkcurso: id
        });
  ...
  updateById: function () {
    var _updateById = _asyncToGenerator(function* (req, res) {
      try {
        var result = yield _Destrezas.default.findByIdAndUpdate(req.params.paramsId, req.body, {
          new: true
        });
        res.status(200).json(result);
      } catch (error) {
  ...
  deleteById: function () {
    var _deleteById = _asyncToGenerator(function* (req, res) {
      try {
        ...
        yield _Destrezas.default.deleteMany({
          _id: {
            $in: array
          }
        });
  ...
  query: function () {
    var _query = _asyncToGenerator(function* (req, res) {
      try {
        ...
        var result = yield _Destrezas.default.find({
          nombre: {
            '$regex': querys,
            "$options": "i"
          }
