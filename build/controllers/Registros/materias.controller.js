...
var _Materias = _interopRequireDefault(require("../../models/registros/Materias"));
...
function editarDistributivo(_x, _x2) {
  return _editarDistributivo.apply(this, arguments);
}

function _editarDistributivo() {
  _editarDistributivo = _asyncToGenerator(function* (idmateria, modelo) {
    var materia = {
      _id: modelo._id,
      area: modelo.area,
...
function eliminarDistributivo(_x3) {
...
var _default = {
  create: function () {
    var _create = _asyncToGenerator(function* (req, res) {
      ...
      try {
        var newData = new _Materias.default({
          nombre,
          area,
          computo
        });
  ...
  get: function () {
    var _get = _asyncToGenerator(function* (req, res) {
      try {
        ...
        var total = yield _Materias.default.countDocuments();
        var paginas = Math.ceil(total / limit);
        var collections = yield _Materias.default.find().skip(limit * skip - limit).limit(limit).lean();
        var coleccion = {
  ...
  getListas: function () {
    var _getListas = _asyncToGenerator(function* (req, res) {
      try {
        var result = yield _Materias.default.find().lean().select({
          nombre: 1,
          area: 1,
          estado: 1,
          computo: 1
  ...
  getById: function () {
    var _getById = _asyncToGenerator(function* (req, res) {
      try {
        ...
        var result = yield _Materias.default.findById(id);
  ...
  updateById: function () {
    var _updateById = _asyncToGenerator(function* (req, res) {
      try {
        var result = yield _Materias.default.findByIdAndUpdate(req.params.paramsId, req.body, {
          new: true
        });
  ...
  deleteById: function () {
    var _deleteById = _asyncToGenerator(function* (req, res) {
      try {
        ...
        yield _Materias.default.deleteMany({
          _id: {
            $in: array
          }
        });
  ...
  activate: function () {
    var _activate = _asyncToGenerator(function* (req, res, next) {
      try {
        var reg = yield _Materias.default.findByIdAndUpdate({
          _id: req.params.id
        }, {
  ...
  query: function () {
    var _query = _asyncToGenerator(function* (req, res) {
      try {
        ...
        var result = yield _Materias.default.find({
          nombre: {
            '$regex': querys,
            "$options": "i"
          }
