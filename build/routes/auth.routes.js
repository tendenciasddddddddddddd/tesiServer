...
router.post("/resetPasswordUsers/:id", [_middlewares.authJwt.verifyToken], authCtrl.resetPasswordUsers);
router.put("/cuenta2/:cuentaId", [_middlewares.authJwt.verifyToken], authCtrl.newPasswordEstudiante);
